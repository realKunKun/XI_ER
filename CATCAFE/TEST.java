...
public class TEST {
    public static void main(String[] args) {
        ...
        MyCatCafe BadHouse=new MyCatCafe();
        BlackCat BadCat=new BlackCat();
        Customer BadCustomer=new Customer();
        BadHouse.BuyCat(BadHouse.GetBalence(),BadCat);
        BadHouse.ServeCustomer(BadCustomer);
        BadHouse.closeCatCafe(LocalDate.of(2021,11,11));

        //NORMAL TEST
        System.out.println("\n"+"NORMAL TEST");
        MyCatCafe WhiteHouse=new MyCatCafe(10000,new LinkedList<Cat>(),new LinkedList<Customer>());
        ...
        Customer Liyuu_= new Customer("Liyuu_",3,LocalDate.of(2021,10,11));
        //test method BuyCat
        ...
        WhiteHouse.closeCatCafe(LocalDate.of(2021,10,11));
